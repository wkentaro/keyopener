...
class Raspi(object):
    def __init__(self):
        ...
        self.pb_rotate_servo = rospy.Publisher('/jishupro/rotate_servo', Float32, queue_size=10)
        self.pb_speak = rospy.Publisher('/jishupro/speak_raspi', String, queue_size=10)
        rospy.sleep(1)
